...
void __main_block_copy_0(struct __main_block_impl_0*dst, struct __main_block_impl_0*src) {
    ...
    _Block_object_assign((void*)&dst->obj2, (__bridge void*)src->obj2, 3/*BLOCK_FIELD_IS_OBJECT*/);
    _Block_object_assign((void*)&dst->weakObj, (__bridge void*)src->weakObj, 3/*BLOCK_FIELD_IS_OBJECT*/);
}
...
void __main_block_dispose_0(struct __main_block_impl_0*src) {
    ...
    _Block_object_dispose((__bridge void*)src->obj2, 3/*BLOCK_FIELD_IS_OBJECT*/);
    _Block_object_dispose((__bridge void*)src->weakObj, 3/*BLOCK_FIELD_IS_OBJECT*/);
}
